...
with open('../data/coauthorship/cora/hypergraph.pickle', 'rb') as handle:
    hypergraph = pickle.load(handle)
with open('../data/coauthorship/cora/features.pickle', 'rb') as handle:
    features = pickle.load(handle).todense()
with open('../data/coauthorship/cora/labels.pickle', 'rb') as handle:
    labels = pickle.load(handle)
with open('../data/coauthorship/cora/splits/9.pickle', 'rb') as handle:
...
plt.savefig('plots/cora/training_loss_seed_9.png')
plt.close()
...
plt.savefig('plots/cora/acc.png')
plt.close()